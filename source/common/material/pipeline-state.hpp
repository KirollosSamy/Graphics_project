...
namespace our
{
    ...
    struct PipelineState
    {
        ...
        void setup() const
        {
            ...
            // glColorMask is an OpenGL function that specifies whether the individual color
            // components in the framebuffer can or cannot be written. If red is GL_FALSE,
            // for example, no change is made to the red component of any pixel in any of the
            // color buffers, regardless of the drawing operation attempted

            glDepthMask(depthMask);
            // glDepthMask is an OpenGL function that enables or disables writing into the depth buffer123. If flag is zero,
